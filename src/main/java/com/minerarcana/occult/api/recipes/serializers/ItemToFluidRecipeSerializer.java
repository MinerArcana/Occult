...
public class ItemToFluidRecipeSerializer<T extends ItemToFluidRecipe> extends ForgeRegistryEntry<IRecipeSerializer<?>> implements IRecipeSerializer<T> {

    private final IFactory<T> factory;


    public ItemToFluidRecipeSerializer(IFactory<T> factory) {
    ...
    public T read(ResourceLocation id, JsonObject json) {
        ...
        ItemStack alternateOut = JSONUtils(json,"alternateOutput").getDefaultInstance();
